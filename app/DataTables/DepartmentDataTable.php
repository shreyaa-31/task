...
class DepartmentDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function($data){
                ...
                if (auth()->user()->hasAnyPermission('department_update')) {
                $inactive .=  '<button type="button" class="btn btn-warning m-1 edit " data-toggle="modal" id="' . $data->id . '"  data-target="#edit-department" ><i class="fa fa-edit"></i></button>';
                }
                if (auth()->user()->hasAnyPermission('department_delete')) {
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('dept_name')->title(__('lang.Department Name')),
